...
export const schedule: ScheduleItem[] = [
  ...
  { id: "sc2", time: "09:30", type: "visit", title: "ביקור בית — יוסף לוי", note: "הערכה תפקודית עדכנית, רמת סיעוד 3." },
  { id: "sc3", time: "11:00", type: "call", title: "שיחת היכרות — רחל מזרחי", note: "התחלת תהליך קליטה וארנק שירותים." },
  ...
  { id: "sc7", time: "15:30", type: "report", title: "סגירת דוח שבועי לרשות", note: "סטטוס 5 מטופלים בסיכון, סיכום פעולות מתאמת." },
];
...
export const alerts: Alert[] = [
  { id: "al1", clientId: "c1", severity: "critical", title: "ציון בדידות ירד — שרה כהן", description: "מ-5 ל-3 בשבועיים האחרונים. נדרשת התערבות מתאמת.", read: false, resolved: false, createdAt: "היום, 07:42" },
  ...
  { id: "al4", clientId: "c10", severity: "info", title: "הערכה תקופתית מתקרבת — אהרן רוזן", description: "תאריך הערכה: 14.05.26. נא לתאם.", read: true, resolved: false, createdAt: "אתמול, 09:00" },
...
export const bookings: Booking[] = [
  { id: "b1", clientId: "c1", serviceId: "s1", date: "2026-04-28", time: "10:00", status: "scheduled", units: 4 },
  { id: "b2", clientId: "c1", serviceId: "s5", date: "2026-04-15", time: "14:00", status: "completed", units: 5 },
  { id: "b3", clientId: "c2", serviceId: "s15", date: "2026-04-26", time: "09:00", status: "completed", units: 3 },
  { id: "b4", clientId: "c3", serviceId: "s13", date: "2026-04-29", time: "11:30", status: "scheduled", units: 6 },
  { id: "b5", clientId: "c4", serviceId: "s5", date: "2026-04-27", time: "13:00", status: "in_progress", units: 5 },
  { id: "b6", clientId: "c5", serviceId: "s3", date: "2026-04-20", time: "16:00", status: "cancelled", units: 2 },
  { id: "b7", clientId: "c6", serviceId: "s4", date: "2026-04-30", time: "17:00", status: "scheduled", units: 3 },
  { id: "b8", clientId: "c7", serviceId: "s1", date: "2026-04-22", time: "10:00", status: "completed", units: 4 },
  { id: "b9", clientId: "c8", serviceId: "s17", date: "2026-04-26", time: "08:00", status: "completed", units: 2 },
  { id: "b10", clientId: "c9", serviceId: "s6", date: "2026-05-02", time: "15:00", status: "scheduled", units: 4 },
  { id: "b11", clientId: "c10", serviceId: "s12", date: "2026-04-18", time: "11:00", status: "completed", units: 12 },
  { id: "b12", clientId: "c11", serviceId: "s8", date: "2026-04-29", time: "12:00", status: "scheduled", units: 5 },
];
