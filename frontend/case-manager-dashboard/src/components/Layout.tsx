...
import { crmActions } from "@libi/shared-ui/data";
import {
    BarChart3,
    Bell,
    Calendar,
...
// Count pending CRM actions
const pendingActionsCount = crmActions.filter((a) => a.status === "pending").length;

const navItems = [
  { path: "/", icon: LayoutDashboard, label: "לוח בקרה" },
  { path: "/actions", icon: Sparkles, label: "פעולות לב", showActionsBadge: true },
  { path: "/clients", icon: Users, label: "מטופלים" },
  { path: "/bookings", icon: Calendar, label: "הזמנות" },
  { path: "/alerts", icon: Bell, label: "התראות", showBadge: true },
        ...
        <div className="p-6 border-b border-gray-100">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500">לוח בקרה מתאמות</p>
            </div>
          </div>
        </div>
          ...
          {navItems.map((item) => {
            ...
            return (
              ...
              >
                ...
                {item.showActionsBadge && pendingActionsCount > 0 && (
                  <Badge className="h-5 min-w-5 px-1.5 bg-primary">
                    {pendingActionsCount}
                  </Badge>
                )}
              </NavLink>
        ...
        <div className="p-4 border-t border-gray-100">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-gray-500 truncate">מתאמת טיפול</p>
            </div>
          </div>
