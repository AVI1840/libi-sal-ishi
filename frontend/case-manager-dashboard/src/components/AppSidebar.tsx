...
import { Heart, LayoutDashboard, Target, Sparkles, Users, UserPlus, Calendar, Bell, FileBarChart2, Settings, LogOut, Building2 } from "lucide-react";
...
const NAV = [
  ...
  { to: "/intake", label: "קליטה חדשה", icon: UserPlus },
  ...
  { to: "/algorithm", label: "אלגוריתם התאמה", icon: Target },
